...
export function getGroupedRowModelUnmemoized<TData extends RowData>(
  table: Table<TData>,
...
export function getGroupedRowModel<TData extends RowData>(middleware?: (rowModel: RowModel<TData>) => RowModel<TData>): (
  table: Table<TData>
) => () => RowModel<TData> {
  return table =>
    memo(
